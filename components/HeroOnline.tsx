        ...
        <View style={styles.container}>
            ...
            <View style={styles.row}>
                ...
                {/* Icon 5 */}
                    ...
                    <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('PayUPI')}>
                ...
                {/* Icon 6 */}
                    ...
                    <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('HomeOffline')}>
                        <MaterialIcons name="signal-cellular-connected-no-internet-0-bar" size={24} color="black" />
